...
mycursor.execute("DROP TABLE IF EXISTS nytToday_US")
mycursor.execute("CREATE TABLE nytToday_US (id INT AUTO_INCREMENT PRIMARY KEY, title VARCHAR(255) NOT NULL, description TEXT, link VARCHAR(255) NOT NULL, date VARCHAR(255), full_article TEXT)")
...
def inputDB(title, link, description, date, article):
    sql = "INSERT INTO nytToday_US (title, description, link, date, full_article) VALUES (%s,%s,%s,%s,%s)"
